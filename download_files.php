...
function GetSubjectsList($events) {
    $subjects = [];
    $temp = [];
...
function GetNormalEvents($events, $subjects, $auditories, $types, $pairs, $group_id) {
    $new_events = [];
...
$url = "http://cist.nure.ua/ias/app/tt/WEB_IAS_TT_GNR_RASP.GEN_GROUP_POTOK_RASP?ATypeDoc=3&Aid_group=$group_id&Aid_potok=0&ADateStart=01.09.2019&ADateEnd=31.01.2020&AMultiWorkSheet=0";
 DownloadFile($url);
...
$subjects = GetSubjectsList($events);
